...
export type Type_169 = Type_169_Response | Type_169_Xcm

export interface Type_169_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export interface Type_169_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}
...
export const Type_193: sts.Type<Type_193> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_196),
        V3: sts.array(() => Type_200),
    }
})
...
export const Type_200: sts.Type<Type_200> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_200),
        SetErrorHandler: sts.array(() => Type_200),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_197: sts.Type<Type_197> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_197 {
    encoded: Bytes
}

export type Type_200 = Type_200_AliasOrigin | Type_200_BurnAsset | Type_200_BuyExecution | Type_200_ClaimAsset | Type_200_ClearError | Type_200_ClearOrigin | Type_200_ClearTopic | Type_200_ClearTransactStatus | Type_200_DepositAsset | Type_200_DepositReserveAsset | Type_200_DescendOrigin | Type_200_ExchangeAsset | Type_200_ExpectAsset | Type_200_ExpectError | Type_200_ExpectOrigin | Type_200_ExpectPallet | Type_200_ExpectTransactStatus | Type_200_ExportMessage | Type_200_HrmpChannelAccepted | Type_200_HrmpChannelClosing | Type_200_HrmpNewChannelOpenRequest | Type_200_InitiateReserveWithdraw | Type_200_InitiateTeleport | Type_200_LockAsset | Type_200_NoteUnlockable | Type_200_QueryPallet | Type_200_QueryResponse | Type_200_ReceiveTeleportedAsset | Type_200_RefundSurplus | Type_200_ReportError | Type_200_ReportHolding | Type_200_ReportTransactStatus | Type_200_RequestUnlock | Type_200_ReserveAssetDeposited | Type_200_SetAppendix | Type_200_SetErrorHandler | Type_200_SetFeesMode | Type_200_SetTopic | Type_200_SubscribeVersion | Type_200_Transact | Type_200_TransferAsset | Type_200_TransferReserveAsset | Type_200_Trap | Type_200_UniversalOrigin | Type_200_UnlockAsset | Type_200_UnpaidExecution | Type_200_UnsubscribeVersion | Type_200_WithdrawAsset

export interface Type_200_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_200_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_200_BuyExecution {
    __kind: 'BuyExecution'
    fees: V3MultiAsset
    weightLimit: V3WeightLimit
}

export interface Type_200_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_200_ClearError {
    __kind: 'ClearError'
}

export interface Type_200_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_200_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_200_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_200_DepositAsset {
    __kind: 'DepositAsset'
    assets: V3MultiAssetFilter
    beneficiary: V3MultiLocation
}

export interface Type_200_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_200_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}

export interface Type_200_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V3MultiAssetFilter
    want: V3MultiAsset[]
    maximal: boolean
...
export interface Type_200_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_200_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_200_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_200_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_200_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_200_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_200_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V3MultiAssetFilter
    reserve: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_200_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_200_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_200_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_200_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_200_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_200_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_200_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_200_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_200_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_200_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_200_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_200_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_200[]
}

export interface Type_200_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_200[]
}

export interface Type_200_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_200_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_200_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}
...
export interface Type_200_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_200_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_200_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_200_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}

export interface Type_200_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export const Type_196: sts.Type<Type_196> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_196),
        SetErrorHandler: sts.array(() => Type_196),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_196 = Type_196_BuyExecution | Type_196_ClaimAsset | Type_196_ClearError | Type_196_ClearOrigin | Type_196_DepositAsset | Type_196_DepositReserveAsset | Type_196_DescendOrigin | Type_196_ExchangeAsset | Type_196_HrmpChannelAccepted | Type_196_HrmpChannelClosing | Type_196_HrmpNewChannelOpenRequest | Type_196_InitiateReserveWithdraw | Type_196_InitiateTeleport | Type_196_QueryHolding | Type_196_QueryResponse | Type_196_ReceiveTeleportedAsset | Type_196_RefundSurplus | Type_196_ReportError | Type_196_ReserveAssetDeposited | Type_196_SetAppendix | Type_196_SetErrorHandler | Type_196_SubscribeVersion | Type_196_Transact | Type_196_TransferAsset | Type_196_TransferReserveAsset | Type_196_Trap | Type_196_UnsubscribeVersion | Type_196_WithdrawAsset

export interface Type_196_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_196_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_196_ClearError {
    __kind: 'ClearError'
}

export interface Type_196_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_196_DepositAsset {
    __kind: 'DepositAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    beneficiary: V2MultiLocation
...
export interface Type_196_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_196_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_196_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}

export interface Type_196_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_196_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_196_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_196_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
    reserve: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_196_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_196_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_196_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_196_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_196_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_196_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_196_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_196_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_196[]
}

export interface Type_196_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_196[]
}

export interface Type_196_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_196_Transact {
    __kind: 'Transact'
    originType: V2OriginKind
    requireWeightAtMost: bigint
    call: Type_197
...
export interface Type_196_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_196_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_196_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_196_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_196_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}

export type Type_193 = Type_193_V2 | Type_193_V3

export interface Type_193_V2 {
    __kind: 'V2'
    value: Type_196[]
}

export interface Type_193_V3 {
    __kind: 'V3'
    value: Type_200[]
}
...
export type Call = Call_AuthorInherent | Call_AuthoritiesNoting | Call_Balances | Call_DmpQueue | Call_MaintenanceMode | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Sudo | Call_System | Call_Timestamp | Call_Utility
