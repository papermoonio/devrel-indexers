...
export type Type_203 = Type_203_Response | Type_203_Xcm

export interface Type_203_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export interface Type_203_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}
...
export type Type_201 = Type_201_EthereumTransaction

export interface Type_201_EthereumTransaction {
...
export const Type_246: sts.Type<Type_246> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_249),
        V3: sts.array(() => Type_253),
    }
})
...
export const Type_253: sts.Type<Type_253> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_253),
        SetErrorHandler: sts.array(() => Type_253),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_250: sts.Type<Type_250> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_250 {
    encoded: Bytes
}

export type Type_253 = Type_253_AliasOrigin | Type_253_BurnAsset | Type_253_BuyExecution | Type_253_ClaimAsset | Type_253_ClearError | Type_253_ClearOrigin | Type_253_ClearTopic | Type_253_ClearTransactStatus | Type_253_DepositAsset | Type_253_DepositReserveAsset | Type_253_DescendOrigin | Type_253_ExchangeAsset | Type_253_ExpectAsset | Type_253_ExpectError | Type_253_ExpectOrigin | Type_253_ExpectPallet | Type_253_ExpectTransactStatus | Type_253_ExportMessage | Type_253_HrmpChannelAccepted | Type_253_HrmpChannelClosing | Type_253_HrmpNewChannelOpenRequest | Type_253_InitiateReserveWithdraw | Type_253_InitiateTeleport | Type_253_LockAsset | Type_253_NoteUnlockable | Type_253_QueryPallet | Type_253_QueryResponse | Type_253_ReceiveTeleportedAsset | Type_253_RefundSurplus | Type_253_ReportError | Type_253_ReportHolding | Type_253_ReportTransactStatus | Type_253_RequestUnlock | Type_253_ReserveAssetDeposited | Type_253_SetAppendix | Type_253_SetErrorHandler | Type_253_SetFeesMode | Type_253_SetTopic | Type_253_SubscribeVersion | Type_253_Transact | Type_253_TransferAsset | Type_253_TransferReserveAsset | Type_253_Trap | Type_253_UniversalOrigin | Type_253_UnlockAsset | Type_253_UnpaidExecution | Type_253_UnsubscribeVersion | Type_253_WithdrawAsset

export interface Type_253_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_253_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_253_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_253_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_253_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_253_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_253_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_253_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_253_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_253_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_253_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_253_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_253_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_253_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_253_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_253_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_253_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_253_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_253_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_253_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_253_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export const Type_249: sts.Type<Type_249> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_249),
        SetErrorHandler: sts.array(() => Type_249),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_249 = Type_249_BuyExecution | Type_249_ClaimAsset | Type_249_ClearError | Type_249_ClearOrigin | Type_249_DepositAsset | Type_249_DepositReserveAsset | Type_249_DescendOrigin | Type_249_ExchangeAsset | Type_249_HrmpChannelAccepted | Type_249_HrmpChannelClosing | Type_249_HrmpNewChannelOpenRequest | Type_249_InitiateReserveWithdraw | Type_249_InitiateTeleport | Type_249_QueryHolding | Type_249_QueryResponse | Type_249_ReceiveTeleportedAsset | Type_249_RefundSurplus | Type_249_ReportError | Type_249_ReserveAssetDeposited | Type_249_SetAppendix | Type_249_SetErrorHandler | Type_249_SubscribeVersion | Type_249_Transact | Type_249_TransferAsset | Type_249_TransferReserveAsset | Type_249_Trap | Type_249_UnsubscribeVersion | Type_249_WithdrawAsset
...
export type Type_246 = Type_246_V2 | Type_246_V3
...
export type Call = Call_AuthorInherent | Call_AuthoritiesNoting | Call_Balances | Call_BaseFee | Call_DmpQueue | Call_DynamicFee | Call_EVM | Call_Ethereum | Call_HotfixSufficients | Call_MaintenanceMode | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Proxy | Call_RootTesting | Call_Sudo | Call_System | Call_Timestamp | Call_TxPause | Call_Utility
